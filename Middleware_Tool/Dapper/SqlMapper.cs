...
#pragma warning restore 618
        ...
        /// <para>参数化SQL执行</para>
        /// </summary>
        /// <param name="cnn">要查询的连接</param>
        /// <param name="sql">为该查询执行的SQL</param>
        /// <param name="param">用于此查询的参数</param>
        /// <param name="transaction">要用于此查询的事务</param>
        /// <param name="commandTimeout">命令执行超时前的秒数</param>
        /// <param name="commandType">它是一个存储的过程还是一个批处理?</param>
